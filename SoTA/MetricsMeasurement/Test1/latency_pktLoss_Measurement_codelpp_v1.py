...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun 19 11:02:58 2023
...
df_pih1_send = pd.read_csv("pih1_codelpp_1.csv", sep=",")
df_pih2_send = pd.read_csv("pih2_codelpp_1.csv", sep=",")
df_pih1_receive = pd.read_csv("pi4_pih1_codelpp_1.csv", sep=",")
df_pih2_receive = pd.read_csv("pi4_pih2_codelpp_1.csv", sep=",")
...
pkt_loss_pih1 = 1 - len(df_pih1_receive)/len(df_pih1_send)
print(datetime.datetime.now(), f"The pkt loss rate of pih1 is: {pkt_loss_pih1}")
pkt_loss_pih2 = 1 - len(df_pih2_receive)/len(df_pih2_send)
