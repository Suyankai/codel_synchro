...
df_pih1_send = pd.read_csv("pih1_Codelpp_synchro_test_45_4.csv", sep=",")
df_pih2_send = pd.read_csv("pih2_Codelpp_synchro_test_45_4.csv", sep=",")
df_pih1_receive = pd.read_csv("pi4_Codelpp_synchro_test_45_4_pih1.csv", sep=",")
df_pih2_receive = pd.read_csv("pi4_Codelpp_synchro_test_45_4_pih2.csv", sep=",")
