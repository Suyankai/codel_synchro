...
if __name__ == "__main__":
   ...
   # Create a figure and axis object
    ...
    boxplot_labels = ["               Baseline","","               Codel","", "               Codelpp","","                SynCodelpp PRIO=4","","                SynCodelpp PRIO=5","","                SynCodelpp PRIO=6","","                SynCodelpp PRIO=7",""]
    ...
    #pkt lost evaluation
    # Sample data
    values = [baseline_pkt_loss_pih1, baseline_pkt_loss_pih2,codel_pkt_loss_pih1, codel_pkt_loss_pih2, codelpp_pkt_loss_pih1, codelpp_pkt_loss_pih2, synPrio4_pkt_loss_pih1,synPrio4_pkt_loss_pih2, synPrio5_pkt_loss_pih1,synPrio5_pkt_loss_pih2, synPrio6_pkt_loss_pih1,synPrio6_pkt_loss_pih2, synPrio7_pkt_loss_pih1, synPrio7_pkt_loss_pih2]
