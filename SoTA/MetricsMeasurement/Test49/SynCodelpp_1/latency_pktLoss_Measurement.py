...
df_pih1_send = pd.read_csv("pih1_SynCodelpp_synchro_test_49_1.csv", sep=",")
df_pih2_send = pd.read_csv("pih2_SynCodelpp_synchro_test_49_1.csv", sep=",")
df_pih1_receive = pd.read_csv("pi4_SynCodelpp_synchro_test_49_1_pih1.csv", sep=",")
df_pih2_receive = pd.read_csv("pi4_SynCodelpp_synchro_test_49_1_pih2.csv", sep=",")
